var app = (function () {
    ...
    /* src/Space.svelte generated by Svelte v3.29.0 */
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			div = element("div");
    			t = text(/*space*/ ctx[0]);
    			attr(div, "class", "space svelte-14c9a2d");
    ...
    const connect = () => {
      try {
        if (!connection || connection.readyState >= 2) {
          connection = new WebSocket({"env":{"apiUrl":"https://tictactoe.pestrickland.co.uk","wsUrl":"wss://tictactoe.pestrickland.co.uk/ws"}}.env.wsUrl);
    ...
    const nextMove = async (space) => {
      try {
        const response = await fetch(`${{"env":{"apiUrl":"https://tictactoe.pestrickland.co.uk","wsUrl":"wss://tictactoe.pestrickland.co.uk/ws"}}.env.apiUrl}/next-turn/${space}`);
    ...
    const reset = async () => {
      try {
        await fetch(`${{"env":{"apiUrl":"https://tictactoe.pestrickland.co.uk","wsUrl":"wss://tictactoe.pestrickland.co.uk/ws"}}.env.apiUrl}/reset`);
      } catch (e) {
        console.log(e);
        return "Error connecting to server";
      }
    ...
    function create_if_block_1(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(button, "class", "svelte-1867j6l");
    		},
    		m(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	return {
    		c() {
    			p = element("p");
    			p.textContent = "Error";
    			attr(p, "class", "errorMessage svelte-1867j6l");
    		},
    		m(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	let if_block2 = /*errorMessage*/ ctx[4] && create_if_block();
    	...
    	return {
    		c() {
    			...
    			t1 = space();
    			h2 = element("h2");
    			t2 = text("Number of people playing: ");
    			...
    			attr(div0, "class", "row svelte-1867j6l");
    			attr(div1, "class", "row svelte-1867j6l");
    			attr(div2, "class", "row svelte-1867j6l");
    			attr(main, "class", "svelte-1867j6l");
    		},
    		m(target, anchor) {
